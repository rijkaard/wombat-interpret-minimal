...
function void abandon_owner(obj this) {
	...
	if (container != NULL()) {
		...
		obj mount_item = getItemAtSlot(container, 0x19);
		if (mount_item != NULL()) {
...
function void execute_attack_command(obj this, obj usedon, obj user) {
	int difficulty;
	difficulty = getStrength(usedon) + getDexterity(usedon) + getSkillLevel(usedon, 0x05) + getSkillLevel(usedon, 0x1B);
	difficulty = difficulty - (getStrength(this) + getDexterity(this) + getSkillLevel(this, 0x05) + getSkillLevel(this, 0x1B));
