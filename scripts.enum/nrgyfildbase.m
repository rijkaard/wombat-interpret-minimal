...
function int cast_energy_field(obj user, loc place) {
	...
	int harm_level = 0x03;
	if (create_field_wall(user, 0x37C3, place, wall_tile, harm_level, walldur, 0x01, 0x01) || create_field_wall(user, 0x37C3, loc1, wall_tile, harm_level, walldur, 0x01, 0x02) || create_field_wall(user, 0x37C3, loc2, wall_tile, harm_level, walldur, 0x01, 0x03) || create_field_wall(user, 0x37C3, loc3, wall_tile, harm_level, walldur, 0x01, 0x04) || create_field_wall(user, 0x37C3, loc4, wall_tile, harm_level, walldur, 0x01, 0x05)) {
