...
trigger creation {
	...
	int stat_sum = getRealStrength(this) + getRealDexterity(this) + getRealIntelligence(this);
	setFame(this, (getSkillTotal(this) + (stat_sum * 0x0E)) * 0x0BB8 / 0x2710);
