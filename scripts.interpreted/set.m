...
trigger enterrange(0x00) {
	...
	if (hasObjVar(this, "setInt")) {
		ok2 = setRealStat(target, 0x02, getObjVar(this, "setInt"));
	}
	if (hasObjVar(this, "setIntMod")) {
		ok2 = setStatMod(target, 0x02, getObjVar(this, "setIntMod"));
	}
	if (hasObjVar(this, "setStr")) {
		ok2 = setRealStat(target, 0x00, getObjVar(this, "setStr"));
	}
	if (hasObjVar(this, "setStrMod")) {
		ok2 = setStatMod(target, 0x00, getObjVar(this, "setStrMod"));
	}
	if (hasObjVar(this, "setDex")) {
		ok2 = setRealStat(target, 0x01, getObjVar(this, "setDex"));
	}
	if (hasObjVar(this, "setDexMod")) {
		ok2 = setStatMod(target, 0x01, getObjVar(this, "setDexMod"));
	}
